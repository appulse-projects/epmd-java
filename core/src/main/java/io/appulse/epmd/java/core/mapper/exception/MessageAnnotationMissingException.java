...
public class MessageAnnotationMissingException extends RuntimeException {
  ...
  public MessageAnnotationMissingException (String message) {
    super(message);
  }

  public MessageAnnotationMissingException (String message, Throwable cause) {
    super(message, cause);
  }

  public MessageAnnotationMissingException (Throwable cause) {
    super(cause);
  }
}
