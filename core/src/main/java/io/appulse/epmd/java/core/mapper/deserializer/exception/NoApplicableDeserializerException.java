...
/**
 * Exception indicates, what there is no any applicable deserializer for message.
 *
 * @since 0.1.0
...
public class NoApplicableDeserializerException extends DeserializationException {
   ...
   */
  public NoApplicableDeserializerException (String message) {
    super(message);
  }
   ...
   */
  public NoApplicableDeserializerException (String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *              (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
   */
  public NoApplicableDeserializerException (Throwable cause) {
    super(cause);
  }
}
