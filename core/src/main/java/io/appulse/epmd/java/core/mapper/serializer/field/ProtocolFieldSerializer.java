...
public final class ProtocolFieldSerializer extends AbstractFieldSerializer<Protocol> {

  @Getter(lazy = true, value = PRIVATE)
  NumberFieldSerializer numberFieldSerializer = createNumberFieldSerializer();

  @Override
  public byte[] write (Protocol protocol) {
    return getNumberFieldSerializer().serialize(protocol.getCode());
  }
