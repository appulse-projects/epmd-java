 ...
 * @since 0.0.1
 */
public final class IterableFieldDeserializer extends AbstractFieldDeserializer<Object> {
  ...
  boolean isApplicable (FieldDescriptor descriptor) {
    return descriptor.getType().isArray() || Iterable.class.isAssignableFrom(descriptor.getType());
  }
}
