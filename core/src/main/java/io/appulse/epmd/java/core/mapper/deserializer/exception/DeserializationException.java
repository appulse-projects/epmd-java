...
public class DeserializationException extends RuntimeException {
  ...
  /**
   * Constructs a new runtime deserialization exception with null as its detail message.
   * <p>
  ...
  /**
   * Constructs a new runtime deserialization exception with the specified detail message.
   * <p>
   * The cause is not initialized, and may subsequently be initialized
   * by a call to Throwable.initCause(java.lang.Throwable).
   *
  ...
  /**
   * Constructs a new runtime deserialization exception with the specified cause and a detail message
